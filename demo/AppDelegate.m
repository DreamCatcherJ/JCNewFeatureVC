...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *path1 = [[NSBundle mainBundle] pathForResource:@"bg1" ofType:@"jpg"];
    NSString *path2 = [[NSBundle mainBundle] pathForResource:@"bg2" ofType:@"jpg"];
    NSString *path3 = [[NSBundle mainBundle] pathForResource:@"bg3" ofType:@"jpg"];
